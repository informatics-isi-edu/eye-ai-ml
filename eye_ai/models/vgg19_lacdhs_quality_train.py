...
def train_and_evaluate(train_path, valid_path, test_path, output_path, best_params, model_name):
    ...
    if model_name:
        ...
        model.save(os.path.join(output_path, 'VGG19_Catalog_LAC_DHS_Quality_Trained_model.h5'))
    ...
    logging.info(f"{model_name} Quality Model trained, Model and training history are saved successfully.")
